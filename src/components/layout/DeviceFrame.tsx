...
export default function DeviceFrame({ children, hideHomeIndicator = false, hideStatusBar = false, outerBackgroundColor }: DeviceFrameProps) {
  return (
    <div 
      className="flex min-h-screen items-center justify-center"
      style={outerBackgroundColor ? { backgroundColor: outerBackgroundColor } : { backgroundColor: '#FFFFFF' }}
    >
