...
const ja = {
  ...
  onboarding3: {
    title: 'あとは週末を楽しむだけ',
    body1: 'PlanMateをフル活用して、',
    body2: '週末プランニングをもっとスマートに',
    cta: 'はじめる',
  },
  signup: {
    title: 'PlanMateへようこそ！',
    ...
    usernameRuleEn: 'Must be lowercase, feel free to use numbers',
    email: 'メールアドレス',
    password: 'パスワード',
    ...
    placeholderUsernameEn: 'Create your username',
    placeholderPassword: 'パスワードを入力',
    placeholderPasswordEn: 'Create your password',
    placeholderPasswordConfirm: '再度パスワードを入力',
    placeholderPasswordConfirmEn: 'Confirm your password',
    cta: 'はじめてみる',
    ctaEn: 'Sign Me Up!',
    legal: '続けることで、利用規約およびプライバシーポリシーに同意したものとみなされます。',
    loginLink: 'すでにアカウントをお持ちですか？ ログイン',
    loginQuestion: 'すでにアカウントをお持ちですか？',
    loginQuestionEn: 'Already have an account?',
    loginAction: 'ログイン',
    loginActionEn: 'Login',
  },
  ...
  eventView: {
    ...
    statusActionRequired: '要対応',
    statusPending: '確認待ち',
    weatherForecast: '天気予報：晴れ',
    viewMap: '地図を見る',
    notesTitle: '注意事項・持ち物',
    checklistTitle: 'チェックリスト',
    addChecklist: 'チェックリストを追加する',
    confirmButton: '確認済みにする',
    changeSchedule: '予定を変更しますか？',
    cancelSchedule: '予定のキャンセル',
    or: 'または',
    requestReproposal: '再提案のリクエスト',
  },
}
...
const en = {
  ...
  eventView: {
    ...
    weatherForecast: 'Weather: Sunny',
    viewMap: 'View Map',
    notesTitle: 'Notes & Items to Bring',
    checklistTitle: 'Checklist',
    addChecklist: 'Add to Checklist',
    confirmButton: 'Mark as Confirmed',
    changeSchedule: 'Change Schedule?',
    cancelSchedule: 'Cancel Schedule',
    or: 'or',
    requestReproposal: 'Request Reproposal',
  },
  login: { title: 'Sign in', email: 'Email', password: 'Password', submit: 'Sign in' },
  dashboard: { title: 'Dashboard' },
  home: { title: 'Trip Plan' },
