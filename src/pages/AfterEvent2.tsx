...
export default function AfterEvent2() {
  return (
    <DeviceFrame hideHomeIndicator>
      ...
      >
        ...
        <div className="absolute bg-[#F3F6F8] h-[974px] left-0 shadow-[0px_26px_60px_rgba(141,155,170,0.05)] top-0 w-[375px]" />

        {/* Content Area */}
        <div className="absolute inset-x-0 top-0 bottom-[125px]">
          {/* Back Button */}
          <div className="absolute left-[18px] top-[49px] z-30 h-[25px] w-[25px]">
            <Icon name="arrow" className="h-full w-full text-white" />
          </div>

          {/* Title */}
          <div className="absolute left-1/2 top-[74px] z-20 h-[30px] w-[234px] -translate-x-1/2">
          ...
          {/* Description */}
          <div className="absolute left-1/2 top-[133px] z-20 w-[290px] -translate-x-1/2">
            <p className="text-[14px] leading-[16px] font-normal text-[#2C4364] text-center tracking-[0.5px]">
              あなたがもっと気に入るプランを考えるので
              <br />
              次も楽しみにしていてね
            </p>
          </div>
          ...
          {/* Image */}
          <div className="absolute left-1/2 top-[200px] z-20 h-[250px] w-[250px] -translate-x-1/2">
            <img
              src="/assets/after-event2-image.png"
              alt=""
