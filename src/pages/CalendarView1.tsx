...
export default function CalendarView1() {
    ...
    <DeviceFrame hideHomeIndicator>
      ...
      >
        ...
        <div className="absolute left-[29px] top-[60px] w-[319px] h-[383px]">
          ...
          {calendarData.map((item, index) => {
            ...
            return (
              ...
              >
                {/* Day Number */}
                <p
                  className={`text-[16px] leading-[26px] text-center ${
                    item.isNextMonth
          ...
          {/* Birthday Star Icons */}
          {/* 9日の星 */}
          <div className="absolute left-[139px] top-[133px] w-[40px] h-[40px] flex items-center justify-center pointer-events-none z-0">
          ...
          <div className="absolute left-[23px] top-[298px] flex flex-col gap-[4px]">
            <div className="flex items-center gap-2">
              ...
              <p className="text-[16px] leading-[26px] font-normal text-[#2C4364]">
                バースデー
              </p>
            </div>
            <div className="flex items-center gap-2">
              <div className="w-[20px] h-[20px] rounded-full bg-[rgba(246,203,213,1.0)]" />
              <p className="text-[16px] leading-[26px] font-normal text-[#2C4364]">
                計画済みの休日
              </p>
            </div>
            <div className="flex items-center gap-2">
              <div className="w-[20px] h-[20px] rounded-full bg-[rgba(196,220,255,1.0)]" />
              <p className="text-[16px] leading-[26px] font-normal text-[#2C4364]">
                未計画の休日
              </p>
            </div>
