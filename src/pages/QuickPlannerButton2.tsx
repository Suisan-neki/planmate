...
export default function QuickPlannerButton2() {
  return (
    <DeviceFrame hideHomeIndicator>
      ...
      >
        ...
        {/* Title */}
        <p className="absolute left-[186.5px] top-[78px] text-[18px] leading-[30px] font-semibold text-[#2C4364] text-center translate-x-[-50%] whitespace-nowrap">
          日にちを選択してください
        </p>

        {/* Description */}
        <p className="absolute left-[86px] top-[211px] w-[236px] text-[14px] leading-[26px] font-normal text-[rgba(44,67,100,0.6)] whitespace-pre-wrap">
          １年以内の日付を選択可能です
        </p>

        {/* Month Dropdown */}
        <div className="absolute left-[40px] top-[156px] z-20 w-[91px] h-[36px]">
        ...
        {/* Day Dropdown */}
        <div className="absolute left-1/2 top-[156px] z-20 w-[91px] h-[36px] -translate-x-1/2">
          <button className="h-[36px] w-[91px] rounded-[30px] bg-white border border-[#969FAB] px-[17px] flex items-center gap-[8px]">
            <span className="text-[13px] leading-[21px] font-medium text-[#2C4364] w-[49px] text-center">
              30
            </span>
        ...
        {/* Year Dropdown */}
        <div className="absolute left-[244px] top-[156px] z-20 w-[91px] h-[36px]">
          <button className="h-[36px] w-[91px] rounded-[30px] bg-white border border-[#969FAB] px-[17px] flex items-center gap-[8px]">
            <span className="text-[13px] leading-[21px] font-medium text-[#2C4364] w-[49px] text-center">
              2025
            </span>
