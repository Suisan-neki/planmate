...
export default function CalendarView2() {
  ...
  const calendarData = [
    ...
    { day: 7, x: 99, y: 201 },
    { day: 8, x: 140, y: 201 },
    { day: 9, x: 183, y: 201, isSelected: true }, // 選択されている日（太字・白文字）
    { day: 10, x: 226, y: 201 },
    { day: 11, x: 270, y: 201 },
    { day: 12, x: 310, y: 201 },
    // 第3週
  ...
  return (
    <DeviceFrame hideHomeIndicator>
      ...
      >
        ...
        {/* Birthday Message */}
        <p className="absolute left-[188.5px] top-[376px] text-[18px] leading-[30px] font-semibold text-[#2C4364] text-center translate-x-[-50%] whitespace-nowrap" style={{ fontFeatureSettings: "'liga' off, 'clig' off" }}>
          userABC、お誕生日おめでとう！
        </p>

        {/* Event Card */}
        <div className="absolute left-[20px] top-[416px] w-[337px] h-[116px] rounded-[20px] bg-white shadow-[0px_16px_60px_rgba(141,155,170,0.1)]">
          {/* Event Image */}
          <div className="absolute left-[18px] top-[35px] w-[60px] h-[58px] rounded-[10px] overflow-hidden">
            <img src="/assets/calendar-view2-event-image.png" alt="ABC遊園地" className="w-full h-full object-cover" />
          </div>

          {/* Event Title */}
          <div className="absolute left-[97px] top-[27px]">
          ...
          <div className="absolute left-[97px] top-[60px]">
            <p className="text-[14px] leading-[20px] font-semibold text-[#969FAB] mb-0">
              10月4日（土）
            </p>
            <p className="text-[14px] leading-[20px] font-semibold text-[#969FAB]">
              天気予報：晴れ
            </p>
          </div>

          {/* Status Button */}
          <div className="absolute right-[19px] top-[72px]">
            <button className="h-[27px] px-[17px] rounded-[26px] bg-[#00C3D0] flex items-center justify-center shadow-[0px_26px_60px_rgba(141,155,170,0.05)]">
