  ...
  return (
    <DeviceFrame>
      <div className="relative w-[375px] h-[812px] mx-auto overflow-hidden text-navy flex flex-col">
        ...
        >
          ...
          <div className="mt-[62px] px-[80px] pb-[15px]">
            <button
              ...
              onClick={() => (window as any).__setDevPage?.('signUp1')}
            >
              {t('onboarding3.cta')}
            </button>
          </div>
        ...
        {/* Legal text */}
        <p className="absolute bottom-[20px] left-1/2 -translate-x-1/2 w-[279px] text-center text-[14px] leading-[26px] font-normal" style={{ color: 'rgba(44, 67, 100, 0.60)' }}>
          続けることで、利用規約とプライバシーポリ
          <br />
          シーに同意したことになります。
        </p>
      </div>
