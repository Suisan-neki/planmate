...
export default function EventView4() {
  return (
    <DeviceFrame hideHomeIndicator>
      ...
      >
        ...
        <div className="absolute inset-x-0 top-0 bottom-[125px] overflow-y-auto overflow-x-hidden">
          {/* Date */}
          <div className="absolute left-[148px] top-[117px] z-20 h-[16px] w-[84px] text-center">
          ...
          {/* Subtitle */}
          <div className="absolute left-[28px] top-[67px] z-20 h-[26px] w-[324px] text-center">
          ...
          <div className="absolute left-[60px] top-[161px] z-20 h-[196px] w-[251px] rounded-[20px] shadow-[0px_16px_60px_rgba(141,155,170,0.1)]" style={{ background: '#29BFC0' }}>
            <div className="absolute inset-0 flex flex-col items-center justify-start pt-[18px]">
              <p className="text-[14px] leading-[26px] font-normal text-black text-center">
                おうちや近所でまったり
              </p>
              <div className="absolute left-[56px] top-[34px] h-[147px] w-[221px] overflow-hidden rounded-[20px]">
                <img
                  src="/assets/event-view4-image1.png"
                  alt="おうちや近所でまったり"
          ...
          {/* Option Card 2 */}
          <div className="absolute left-[60px] top-[381px] z-20 h-[196px] w-[251px] rounded-[20px] shadow-[0px_16px_60px_rgba(141,155,170,0.1)]" style={{ background: '#F3F6F8' }}>
            <div className="absolute inset-0 flex flex-col items-center justify-start pt-[16px]">
              <p className="text-[14px] leading-[26px] font-normal text-black text-center">
                アクティブに過ごす
              </p>
              <div className="absolute left-[51px] top-[47px] h-[149px] w-[149px] overflow-hidden rounded-[20px]">
                <img
                  src="/assets/event-view4-image2.png"
                  alt="アクティブに過ごす"
                  className="absolute object-cover object-center"
                  style={{ 
                    left: '50%', 
          ...
          {/* Option Card 3 */}
          <div className="absolute left-[57px] top-[603px] z-20 h-[196px] w-[251px] rounded-[20px] shadow-[0px_16px_60px_rgba(141,155,170,0.1)]" style={{ background: '#F3F6F8' }}>
            <div className="absolute inset-0 flex flex-col items-center justify-start pt-[16px]">
              <p className="text-[14px] leading-[26px] font-normal text-black text-center">
                ショッピング
              </p>
              <div className="absolute left-[27px] top-[34px] h-[164px] w-[198px] overflow-hidden rounded-[20px]">
                <img
                  src="/assets/event-view4-image3.png"
                  alt="ショッピング"
                  className="absolute object-cover object-center"
                  style={{ 
                    left: '50%', 
          ...
          {/* Cancel Button */}
          <div className="absolute left-[19px] top-[823px] z-20 h-[50px] w-[341px]">
          ...
          {/* Delegate Button */}
          <div className="absolute left-[19px] top-[895px] z-20 h-[50px] w-[341px]">
            <div className="absolute inset-0 bg-[#2C4364] rounded-[26px] shadow-[0px_26px_60px_rgba(141,155,170,0.05)]" />
            <button className="absolute inset-0 flex items-center justify-center">
              <span className="text-[16px] leading-[28px] font-semibold text-white">
                すべてお任せする
        ...
        <div className="absolute bottom-0 left-0 right-0 z-30 h-[125px] w-[375px]">
          ...
          <div className="absolute inset-0">
            ...
            <div className="absolute inset-x-0 bottom-0 h-[102px] rounded-t-[25px] shadow-[0px_26px_60px_rgba(141,155,170,0.05)]" style={{ background: '#F3F6F8' }}>
              {/* Home indicator */}
