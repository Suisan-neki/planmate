        ...
        <div className="absolute inset-x-0 top-0 z-0 h-[566px] rounded-b-[28px]" style={{ background: 'inherit' }}>
          ...
          >
            <path
              ...
              fill="url(#forgot1-ring-gradient-left)"
              fillOpacity={0.2}
            />
            <defs>
              <linearGradient
                id="forgot1-ring-gradient-left"
                x1="366.57"
                y1="464.364"
                x2="-55.3377"
                y2="-8.49122"
          ...
          >
            <path
              ...
              fill="url(#forgot1-ring-gradient-right)"
              fillOpacity={0.2}
            />
            <defs>
              <linearGradient
                id="forgot1-ring-gradient-right"
                x1="-234.57"
                y1="-278.364"
                x2="201.5"
                y2="241"
        ...
        >
          <div className="flex flex-col translate-y-4">
            ...
            <button
              ...
              onClick={() => (window as any).__setDevPage?.('forgot2')}
            >
              {t('forgot.cta')}
            </button>
          </div>
