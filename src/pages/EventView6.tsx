...
export default function EventView6() {
  return (
    <DeviceFrame hideHomeIndicator>
      ...
      >
        ...
        <div className="absolute left-[61px] top-[137px] z-20 h-[250px] w-[250px]">
          {/* Background Circle */}
          <img
            src="/assets/event-view6-loading-circle-bg.png"
            alt=""
          ...
          {/* Progress Circle */}
          <img
            src="/assets/event-view6-loading-circle-progress.png"
            alt=""
            className="absolute inset-0 h-full w-full"
          />

          {/* Lightbulb Icon */}
          <div className="absolute left-[60px] top-[60px] h-[130px] w-[130px]">
            <img
              src="/assets/event-view6-lightbulb-icon.png"
              alt=""
        ...
        {/* Loading Text */}
        <div className="absolute left-[124px] top-[447px] z-20 h-[30px] w-[123px] text-center">
          <p className="text-[18px] leading-[30px] font-semibold text-[#2C4364] whitespace-nowrap">
            提案の準備中...
          </p>
        </div>
